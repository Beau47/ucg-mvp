...
{'page': 1, 'type': 'heading', 'text': 'Prerequisites'},
 ...
 'blocks': [{'page': 1, 'type': 'heading', 'text': 'Lesson 6.0 – Recursion'},
            ...
            {'page': 1,
             'type': 'list',
             'items': ['Explain what recursion is and how a recursive function solves a problem.',
                       'Identify the base case and recursive case in a recursive function.',
                       'Trace recursive function calls and describe how the call stack changes.',
                       'Write recursive functions that solve problems using smaller versions of themselves.',
                       'Recognize when missing or unreachable base cases cause a RecursionError.']},
            {'page': 1, 'type': 'heading', 'text': 'Vocabulary'},
            {'page': 1,
             'type': 'rich_paragraph',
             'html': '<span style="background:#fff1df; color:#c74716; padding:2px 7px; border-radius:6px; '
